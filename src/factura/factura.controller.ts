...
export class FacturaController {
    ...
    //Ejercicio 8
    @Patch('updateFactura/:nroFactura')
    async update(@Param('nroFactura') nroFactura: number, @Body(new ValidationPipe({ transform: true })) dto:UpdateFacturaDto):Promise<Factura>{
        return this.facturaService.update(nroFactura, dto);
}
